--------------------------------------------------------
-- Archivo creado  - lunes-enero-07-2019   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Type SYS_PLSQL_25506_DUMMY_1
--------------------------------------------------------

  CREATE OR REPLACE TYPE "VDIRMP"."SYS_PLSQL_25506_DUMMY_1" as table of number;

/
--------------------------------------------------------
--  DDL for Type SYS_PLSQL_25506_12_1
--------------------------------------------------------

  CREATE OR REPLACE TYPE "VDIRMP"."SYS_PLSQL_25506_12_1" as object (IDX NUMBER,
DATO VARCHAR2(4000));

/
--------------------------------------------------------
--  DDL for Type SYS_PLSQL_25506_27_1
--------------------------------------------------------

  CREATE OR REPLACE TYPE "VDIRMP"."SYS_PLSQL_25506_27_1" as table of VDIRMP."SYS_PLSQL_25506_12_1";
...
SET DEFINE OFF;
Insert into VDIRMP.VDIR_FILE (COD_FILE,DES_FILE,OBSERVACION,RUTA,COD_TIPO_FILE,FECHA_CREACION,URL) values ('1','Contrato Oro Plus',null,'./asset/public/uploadPdf/Contrato/MPFT642_CONTRATO_ORO_PLUS.pdf','3',to_date('02/01/19','DD/MM/RR'),'https://secure.na2.echosign.com/public/esignWidget?wid=CBFCIBAA3AAABLblqZhCvP7SHTBGJ5iNhNIrwaq--2nL4mZumX02lCh1hiS5N97eNix81P3xsLradMuVt1xY*');
...
SET DEFINE OFF;
Insert into VDIRMP.VDIR_PARAMETRO (COD_PARAMETRO,DES_PARAMETRO,VALOR_PARAMETRO,COD_ESTADO) values ('4','Url contrato','https://secure.na2.echosign.com/public/esignWidget?wid=CBFCIBAA3AAABLblqZhCvP7SHTBGJ5iNhNIrwaq--2nL4mZumX02lCh1hiS5N97eNix81P3xsLradMuVt1xY*','1');
...
Insert into VDIRMP.VDIR_PERSONA (COD_PERSONA,COD_TIPO_IDENTIFICACION,NUMERO_IDENTIFICACION,NOMBRE_1,NOMBRE_2,APELLIDO_1,APELLIDO_2,FECHA_NACIMIENTO,TELEFONO,EMAIL,DIRECCION,COD_SEXO,COD_MUNICIPIO,FECHA_CREACION,COD_ESTADO,CELULAR,COD_EPS,COD_ESTADO_CIVIL,IND_TIENE_MASCOTA,DIR_TIPO_VIA,DIR_NUM_VIA,DIR_NUM_PLACA,DIR_COMPLEMENTO) values ('21','1','1059900122','diego',null,'castillo',null,to_date('04/12/18','DD/MM/RR'),'12545','hidalgoever@live.com',null,'2',null,to_date('20/12/18','DD/MM/RR'),'1','3215485693',null,null,null,null,null,null,null);
Insert into VDIRMP.VDIR_PERSONA (COD_PERSONA,COD_TIPO_IDENTIFICACION,NUMERO_IDENTIFICACION,NOMBRE_1,NOMBRE_2,APELLIDO_1,APELLIDO_2,FECHA_NACIMIENTO,TELEFONO,EMAIL,DIRECCION,COD_SEXO,COD_MUNICIPIO,FECHA_CREACION,COD_ESTADO,CELULAR,COD_EPS,COD_ESTADO_CIVIL,IND_TIENE_MASCOTA,DIR_TIPO_VIA,DIR_NUM_VIA,DIR_NUM_PLACA,DIR_COMPLEMENTO) values ('41','1','10696369','diego ','armando','castillo','cordoba',to_date('13/12/16','DD/MM/RR'),'3325986','hidalgoever@live.com',null,'1',null,to_date('04/01/19','DD/MM/RR'),'1','321758632',null,null,null,null,null,null,null);
...
/*---------------------------------------------------------------------
 ...
 /* ------------------------------------------
  fn_splitData: funcion para retornar cursor con los datos de una cadena separados por un caracter
 -- ------------------------------------------  */
...
/* ---------------------------------------------------------------------
 ...
 /*---------------------------------------------------------------------
  fn_splitData: Traer los beneficiarios que esta registrando un contratante
  ----------------------------------------------------------------------
  Autor : diego.castillo@kalettre.com
  Fecha : 02-01-2019
 ----------------------------------------------------------------------- */  
 ...
 END fn_get_promocion_producto;
	...
	/* ---------------------------------------------------------------------
	 ...
	 ----------------------------------------------------------------- */
		...
		SELECT '' numeroContrato, -- Secuencia
		       '' tipoPlan, --vdir_tarifa
			   ...
			   EXTRACT(YEAR FROM SYSDATE) yearVigencia,
			   EXTRACT(MONTH FROM SYSDATE) mesVigencia,
			   EXTRACT(DAY FROM SYSDATE) diaVigencia,
			   ADD_MONTHS(SYSDATE, 12) vigencia, -- sumar año
			   '' tarifaCuota,
			   '' formaPago,
			   '0' periodoPago,
			   EXTRACT(YEAR FROM SYSDATE) yearFirma,
			   EXTRACT(MONTH FROM SYSDATE) mesFirma,
			   EXTRACT(DAY FROM SYSDATE) diaFirma,
			   EXTRACT(YEAR FROM SYSDATE) yearContratacion,
			   EXTRACT(MONTH FROM SYSDATE) mesContratacion,
			   EXTRACT(DAY FROM SYSDATE) diaContratacion
	...
	BEGIN
		...
		lvc_url := lvc_url||chr(38)||'radTipoPlan='            ||ltc_contratante.tipoPlan;
		...
		lvc_url := lvc_url||chr(38)||'radFormaPago='        ||ltc_contratante.formaPago;
		lvc_url := lvc_url||chr(38)||'radPeriodoPago='      ||ltc_contratante.periodoPago;
