--------------------------------------------------------
-- Archivo creado  - martes-enero-08-2019   
--------------------------------------------------------
--------------------------------------------------------
--  DDL for Type SYS_PLSQL_25506_DUMMY_2
--------------------------------------------------------

  CREATE OR REPLACE TYPE "VDIRMP"."SYS_PLSQL_25506_DUMMY_2" as table of number;

/
--------------------------------------------------------
--  DDL for Type SYS_PLSQL_25506_12_2
--------------------------------------------------------

  CREATE OR REPLACE TYPE "VDIRMP"."SYS_PLSQL_25506_12_2" as object (IDX NUMBER,
DATO VARCHAR2(4000));

/
--------------------------------------------------------
--  DDL for Type SYS_PLSQL_25506_27_2
--------------------------------------------------------

  CREATE OR REPLACE TYPE "VDIRMP"."SYS_PLSQL_25506_27_2" as table of VDIRMP."SYS_PLSQL_25506_12_2";
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "VDIRMP"."VDIR_SEQ_CONTRATANTE_BENEFI"  MINVALUE 1 MAXVALUE 9999999999999999999999999 INCREMENT BY 1 START WITH 21 CACHE 20 NOORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence VDIR_SEQ_LOG_USUARIOS_SISTEMA
--------------------------------------------------------

   CREATE SEQUENCE  "VDIRMP"."VDIR_SEQ_LOG_USUARIOS_SISTEMA"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 301 CACHE 20 ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence VDIR_SEQ_PERSONA
--------------------------------------------------------

   CREATE SEQUENCE  "VDIRMP"."VDIR_SEQ_PERSONA"  MINVALUE 1 MAXVALUE 9999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 ORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into VDIRMP.VDIR_FILE (COD_FILE,DES_FILE,OBSERVACION,RUTA,COD_TIPO_FILE,FECHA_CREACION,URL) values ('1','Contrato Oro Plus',null,'./asset/public/uploadPdf/Contrato/MPFT642_CONTRATO_ORO_PLUS.pdf','3',to_date('02/01/19','DD/MM/RR'),'https://coomeva.na1.echosign.com/public/esignWidget?wid=CBFCIBAA3AAABLblqZhDJmffOxsmDdghRoYM8F-V6KiDco3AIK-Oe4WIXYeXx7wXIKaRMBgkZfH7YAgE7zCY*');
Insert into VDIRMP.VDIR_FILE (COD_FILE,DES_FILE,OBSERVACION,RUTA,COD_TIPO_FILE,FECHA_CREACION,URL) values ('2','Contrato Asociado',null,'./asset/public/uploadPdf/Contrato/MPFT674_CONTRATO_ASOCIADO.pdf','3',to_date('02/01/19','DD/MM/RR'),'https://coomeva.na1.echosign.com/public/esignWidget?wid=CBFCIBAA3AAABLblqZhCDw6hOispNIMTlrEPbCf99lPe2D81OxZbAYHC9O1VHxyxVVQ8oneYQAllN_aA-xzs*');
Insert into VDIRMP.VDIR_FILE (COD_FILE,DES_FILE,OBSERVACION,RUTA,COD_TIPO_FILE,FECHA_CREACION,URL) values ('3','Contrato Tradicional Especial',null,'./asset/public/uploadPdf/Contrato/MPFT648_CONTRATO_TRADICIONAL_ESPECIAL.pdf','3',to_date('02/01/19','DD/MM/RR'),'https://secure.na2.echosign.com/public/esignWidget?wid=CBFCIBAA3AAABLblqZhC-ettmJBPt37hUufG_XdpCQYoY84d7hVnxAkyfRwNBVaxz5PG9r7BhxnKdqCmaqVs*');
Insert into VDIRMP.VDIR_FILE (COD_FILE,DES_FILE,OBSERVACION,RUTA,COD_TIPO_FILE,FECHA_CREACION,URL) values ('4','Contrato Plata Joven',null,'./asset/public/uploadPdf/Contrato/MPFT645_CONTRATO_PLATA_JOVEN.pdf','3',to_date('02/01/19','DD/MM/RR'),'https://secure.na2.echosign.com/public/esignWidget?wid=CBFCIBAA3AAABLblqZhDUE1fIvxnLta6URLbkaPunNvPb2YJDGX3uFehZw4Z1ectsvx8xjUpA0AUk9zOpJa4*');
Insert into VDIRMP.VDIR_FILE (COD_FILE,DES_FILE,OBSERVACION,RUTA,COD_TIPO_FILE,FECHA_CREACION,URL) values ('5','Contrato Cem',null,'./asset/public/uploadPdf/Contrato/MPFT675_CONTRATO_CEM.pdf','3',to_date('02/01/19','DD/MM/RR'),'https://secure.na2.echosign.com/public/esignWidget?wid=CBFCIBAA3AAABLblqZhBvVyiJqtQND7w2GLhYEHPsuPVYz_j9-m8dMRMH29phYqgKQrRXY3ZGYPa-zs3I_co*');
Insert into VDIRMP.VDIR_FILE (COD_FILE,DES_FILE,OBSERVACION,RUTA,COD_TIPO_FILE,FECHA_CREACION,URL) values ('6','Contrato Dental Elite',null,'./asset/public/uploadPdf/Contrato/MPFT647_CONTRATO_DENTAL_ELITE.pdf','3',to_date('02/01/19','DD/MM/RR'),'https://secure.na2.echosign.com/public/esignWidget?wid=CBFCIBAA3AAABLblqZhA0WvIAnsdHIUEmKeqiXjSCBX9yMWG2ZVzhl29X0fjwyeo_VeZo8gNNyBvqX6Z8mdE*');
Insert into VDIRMP.VDIR_FILE (COD_FILE,DES_FILE,OBSERVACION,RUTA,COD_TIPO_FILE,FECHA_CREACION,URL) values ('7','Inclusión Solicitud de Ingreso',null,'./asset/public/uploadPdf/Inclusion/MPFT003_SOLICITUD_INGRESO.pdf','4',to_date('02/01/19','DD/MM/RR'),'https://secure.na2.echosign.com/public/esignWidget?wid=CBFCIBAA3AAABLblqZhAxuW3nEWwQzMLmcOJXYH_pnflQUvzW-u60k3J09x7miEbn6oRMtfYUGhXfFGY0qJ0*');
Insert into VDIRMP.VDIR_FILE (COD_FILE,DES_FILE,OBSERVACION,RUTA,COD_TIPO_FILE,FECHA_CREACION,URL) values ('8','Inclusión tratamiento de datos personales',null,'./asset/public/uploadPdf/Inclusion/MPDC311_TRATAMIENTO_DATOS_PERSONALES.pdf','4',to_date('02/01/19','DD/MM/RR'),'https://secure.na2.echosign.com/public/esignWidget?wid=CBFCIBAA3AAABLblqZhC0sDi4Rqr917w9ACqXUSuYtvknn9LVSa7RrnbkEG09vseCJckqmduoRP1gScekrNE*');
Insert into VDIRMP.VDIR_FILE (COD_FILE,DES_FILE,OBSERVACION,RUTA,COD_TIPO_FILE,FECHA_CREACION,URL) values ('9','Inclusión Cuota Mes',null,'./asset/public/uploadPdf/Inclusion/MPFT083_CUOTA_MES.pdf','4',to_date('02/01/19','DD/MM/RR'),'https://secure.na2.echosign.com/public/esignWidget?wid=CBFCIBAA3AAABLblqZhBK83pp4OTvz2SIJczuIuGaiktmvdQB60gtKrvH0aC46v4ll9vz6J-TDNaw6FAa1NY*');
Insert into VDIRMP.VDIR_FILE (COD_FILE,DES_FILE,OBSERVACION,RUTA,COD_TIPO_FILE,FECHA_CREACION,URL) values ('10','Imagen 1 del carrucel',null,'./asset/public/fileUpload/bg.jpg','5',to_date('07/01/19','DD/MM/RR'),null);
Insert into VDIRMP.VDIR_FILE (COD_FILE,DES_FILE,OBSERVACION,RUTA,COD_TIPO_FILE,FECHA_CREACION,URL) values ('11','Imagen 2 del carrucel',null,'./asset/public/fileUpload/bg2.jpg','5',to_date('07/01/19','DD/MM/RR'),null);
Insert into VDIRMP.VDIR_FILE (COD_FILE,DES_FILE,OBSERVACION,RUTA,COD_TIPO_FILE,FECHA_CREACION,URL) values ('12','Imagen 3  del carrucel',null,'./asset/public/fileUpload/bg3.jpg','5',to_date('07/01/19','DD/MM/RR'),null);
...
Insert into VDIRMP.VDIR_PERSONA (COD_PERSONA,COD_TIPO_IDENTIFICACION,NUMERO_IDENTIFICACION,NOMBRE_1,NOMBRE_2,APELLIDO_1,APELLIDO_2,FECHA_NACIMIENTO,TELEFONO,EMAIL,DIRECCION,COD_SEXO,COD_MUNICIPIO,FECHA_CREACION,COD_ESTADO,CELULAR,COD_EPS,COD_ESTADO_CIVIL,IND_TIENE_MASCOTA,DIR_TIPO_VIA,DIR_NUM_VIA,DIR_NUM_PLACA,DIR_COMPLEMENTO) values ('21','1','1059900122','diego',null,'castillo',null,to_date('04/12/18','DD/MM/RR'),'12545','hidalgoever@live.com',null,'2',null,to_date('20/12/18','DD/MM/RR'),'1','3215485693',null,null,null,'11',null,null,null);
Insert into VDIRMP.VDIR_PERSONA (COD_PERSONA,COD_TIPO_IDENTIFICACION,NUMERO_IDENTIFICACION,NOMBRE_1,NOMBRE_2,APELLIDO_1,APELLIDO_2,FECHA_NACIMIENTO,TELEFONO,EMAIL,DIRECCION,COD_SEXO,COD_MUNICIPIO,FECHA_CREACION,COD_ESTADO,CELULAR,COD_EPS,COD_ESTADO_CIVIL,IND_TIENE_MASCOTA,DIR_TIPO_VIA,DIR_NUM_VIA,DIR_NUM_PLACA,DIR_COMPLEMENTO) values ('41','1','10696369','diego ','armando','castillo','cordoba',to_date('13/12/16','DD/MM/RR'),'3325986','hidalgoever@live.com',null,'1',null,to_date('04/01/19','DD/MM/RR'),'1','321758632',null,null,null,'11',null,null,null);
...
/*---------------------------------------------------------------------
 ...
 /*---------------------------------------------------------------------
  fn_get_benficiarios_cotra: Traer los beneficiarios que esta registrando un contratante
 ----------------------------------------------------------------------- */
 FUNCTION fn_get_benficiarios_cotra
 (
    pty_cod_usuario in vdir_usuario.cod_usuario%type
 )RETURN type_cursor;
...
--------------------------------------------------------
 ...
 BEGIN
  ...
  FOR 
      ...
      SELECT 
        fil.ruta AS RUTA_FILE
      FROM
        VDIR_TARIFA tarifa
        
        INNER JOIN VDIR_TARIFA_FILE file_tarifa
         ON file_tarifa.COD_TARIFA = tarifa.COD_TARIFA
        
        INNER JOIN VDIR_FILE fil
         ON fil.COD_FILE = file_tarifa.COD_FILE
        
        WHERE
         tarifa.COD_PLAN = p_codigo_plan
         AND tarifa.COD_ESTADO = 1;
 ...
 BEGIN 
     BEGIN
        ...
        SELECT
            ...
            1 AS "parentesco", --fn_get_parentesco(us.cod_persona, pr.cod_persona)
            1 AS "tarifa" --fn_get_tarifa(us.cod_persona, pr.cod_persona)
        FROM
            vdir_usuario us
            INNER JOIN vdir_contratante_beneficiario cb ON cb.cod_contratante = us.cod_persona
            INNER JOIN vdir_afiliacion va ON va.cod_afiliacion = cb.cod_afiliacion
            ...
            INNER JOIN vdir_municipio mu ON mu.cod_municipio = pr.cod_municipio
            INNER JOIN vdir_departamento dp ON dp.cod_departamento = mu.cod_departamento
          WHERE
              us.cod_usuario = pty_cod_usuario
              AND va.cod_estado = 3;
    EXCEPTION 
 ...
 BEGIN
    ...
    BEGIN
        ...
        DELETE FROM 
            vdir_contratante_beneficiario
        WHERE
            cod_afiliacion = fn_get_afiliacion_pendiente(pty_cod_usuario);
    COMMIT;        
    EXCEPTION 
        WHEN NO_DATA_FOUND THEN
        pnu_result := 0;
...
/* ---------------------------------------------------------------------
 ...
 END fn_get_promocion_producto;
	...
	/* ---------------------------------------------------------------------
	 ...
	 lvc_url           Url proveniente de Adobe Sign
	 ----------------------------------------------------------------------
	 Historia de Modificaciones
	 ----------------------------------------------------------------------
	 Fecha Autor Modificación
	 ----------------------------------------------------------------- */
		...
		SELECT '12345679' numeroContrato, -- Secuencia
		       '1' tipoPlan, --vdir_tarifa
			   ...
			   TO_CHAR(SYSDATE, 'YYYY') yearVigencia,
			   TO_CHAR(SYSDATE, 'MM') mesVigencia,
			   TO_CHAR(SYSDATE, 'DD') diaVigencia,
			   TO_CHAR(ADD_MONTHS(SYSDATE, 12), 'DD/MM/YYYY') vigencia, -- sumar año
			   '0' tarifaCuota,
			   '2' formaPago,
			   '1' periodoPago,
		 ...
		 WHERE pers.cod_persona = inu_codPersona;
	...
	BEGIN
		...
		lvc_url := lvc_url||'#txtNumeroContrato='              ||ltc_contratante.numeroContrato;

		-- Si el tipo de Plan es familiar
		IF ltc_contratante.tipoPlan = 1 THEN

		    lvc_url := lvc_url||chr(38)||'txtPlanFamiliar=X';

		-- Si el tipo de Plan es colectivo	
		ELSIF ltc_contratante.tipoPlan = 2 THEN
		...
		lvc_url := lvc_url||chr(38)||'txtYearVigencia='     ||ltc_contratante.yearVigencia;
		lvc_url := lvc_url||chr(38)||'txtMesVigencia='      ||ltc_contratante.mesVigencia;
		lvc_url := lvc_url||chr(38)||'txtDiaVigencia='      ||ltc_contratante.diaVigencia;
		lvc_url := lvc_url||chr(38)||'txtVigencia='         ||ltc_contratante.vigencia;
