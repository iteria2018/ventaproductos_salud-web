...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "VDIRMP"."VDIR_SEQ_LOG_USUARIOS_SISTEMA"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 61 CACHE 20 ORDER  NOCYCLE ;
--------------------------------------------------------
...
Insert into VDIRMP.VDIR_PREGUNTA (COD_PREGUNTA,DES_PREGUNTA,COD_ENCUESTA,NUMERO_PREGUNTA,COD_MODULO) values ('6','Usted realiza transacciones en moneda extranjera','1','6',null);
Insert into VDIRMP.VDIR_PREGUNTA (COD_PREGUNTA,DES_PREGUNTA,COD_ENCUESTA,NUMERO_PREGUNTA,COD_MODULO) values ('7','Seleccione el tipo de transacciones que realiza','1','7',null);
...
SET DEFINE OFF;
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('27','<label>Detalle el concepto de otros Ingresos diferentes a la Actiividad Principal</label> <input type="text" id="concept" name="concept" class="form-control campo-vd" disabled>',null,'3','7');
...
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('25','<input class="form-control campo-vd" type="text" name="valor_activo" id="valor_activo"  maxlength="17">',null,'4','1');
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('26','<input class="form-control campo-vd" type="text" name="valor_pasivo" id="valor_pasivo"  maxlength="17" >',null,'5','1');
      ...
      vl_form_fin := '</form></div>';      
       ...
       FOR fila IN (SELECT
                    ...
                    FROM
                        vdir_pregunta
                    WHERE
                       cod_encuesta = 1 ORDER BY numero_pregunta)  LOOP 
         vl_row_respuesta := '';
         vl_style := '';
          FOR fila2 IN(SELECT
                            cod_respuesta,
                        ...
                        FROM
                            vdir_respuesta
                        WHERE
                           cod_pregunta = fila.cod_pregunta  ORDER BY numero_respuesta) LOOP
        IF fila.cod_pregunta NOT IN(4,5) AND fila2.cod_respuesta <> 27 THEN                
           vl_row_respuesta := vl_row_respuesta || '<div class="form-check">                                                 
                                                    <label class="form-check-label">
                                                          <input class="form-check-input" type="radio" name="radio_respuesta_n_'||CAST(fila.cod_pregunta AS VARCHAR2)||'" id="radio_respuesta_'||CAST(fila2.cod_respuesta AS VARCHAR2)||'" value="'||CAST(fila2.cod_respuesta AS VARCHAR2)||'"> '||fila2.des_respuesta||'
                                                          <span class="circle">
         ...
         IF fila.cod_pregunta NOT IN(4,5) THEN 
         ...
         ELSE
            ...
            vl_row_pregunta := vl_row_pregunta || '<div class="row">
                                                       <div '||vl_style||' class="col-lg-4 col-md-4 col-sm-4" id="pregunta_'||CAST(fila.cod_pregunta AS VARCHAR2)||'">
                                                         <div class="title">
                                                                <h4 class="obligatorio">'||fila.des_pregunta||'</h4>
                                                         </div>
                                                         '||vl_row_respuesta||'
