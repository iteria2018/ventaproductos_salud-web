...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "VDIRMP"."VDIR_SEQ_AFILIACION_ENCUESTA"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 ORDER  NOCYCLE ;
--------------------------------------------------------
--  DDL for Sequence VDIR_SEQ_LOG_USUARIOS_SISTEMA
--------------------------------------------------------

   CREATE SEQUENCE  "VDIRMP"."VDIR_SEQ_LOG_USUARIOS_SISTEMA"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 81 CACHE 20 ORDER  NOCYCLE ;
--------------------------------------------------------
...
--------------------------------------------------------
   ...
   CREATE SEQUENCE  "VDIRMP"."VDIR_SEQ_RESPUESTAS_MARCADAS"  MINVALUE 1 MAXVALUE 999999999999999999999999999 INCREMENT BY 1 START WITH 1 CACHE 20 ORDER  NOCYCLE ;
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('51','<div class="col-lg-12  col-md-12  col-sm-12"><input type="text" id="declaro" name="declaro" class="form-control campo-vd"  maxlength="400"></div>',null,'38','1');
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('27','<div class="col-lg-6 col-md-6 col-sm-6"><label>Detalle el concepto de otros Ingresos diferentes a la Actiividad Principal</label> <input type="text" id="concept" name="concept" class="form-control campo-vd" disabled></div>',null,'3','7');
...
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('30','<div class="col-lg-6 col-md-6 col-sm-6"><label>Nombre del banco</label> <input type="text" id="nom_banco" name="nom_banco" class="form-control campo-vd" disabled ></div>',null,'34','3');
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('31','<div class="col-lg-6 col-md-6 col-sm-6"><label>Ciudad</label> <input type="text" id="ciudad" name="ciudad" class="form-control campo-vd" disabled ></div>',null,'34','4');
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('32','<div class="col-lg-6 col-md-6 col-sm-6"><label>Pa&iacute;s</label> <input type="text" id="pais" name="pais" class="form-control campo-vd" disabled ></div>',null,'34','5');
...
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('36','<div class="col-lg-6 col-md-6 col-sm-6"><label>Cargo</label> <input type="text" id="cargo" name="cargo" class="form-control campo-vd" maxlength="50" disabled ></div>',null,'35','3');
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('37','<div class="col-lg-6 col-md-6 col-sm-6"><label>Fecha de Inicio</label> <input type="text" id="fecha_ini" name="fecha_ini" class="form-control campo-vd" disabled ></div>',null,'35','4');
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('38','<div class="col-lg-6 col-md-6 col-sm-6"><label>Fecha Fin</label> <input type="text" id="fecha_fin" name="fecha_fin" class="form-control campo-vd" disabled></div>',null,'35','5');
...
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('41','<div class="col-lg-6 col-md-6 col-sm-6"><label>Organización</label> <input type="text" id="organizacion" name="organizacion" class="form-control campo-vd" maxlength="50" disabled ></div>',null,'36','3');
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('42','<div class="col-lg-6 col-md-6 col-sm-6"><label>Fecha de Inicio</label> <input type="text" id="fecha_ini_1" name="fecha_ini_1" class="form-control campo-vd" disabled ></div>',null,'36','4');
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('43','<div class="col-lg-6 col-md-6 col-sm-6"><label>Fecha Fin</label> <input type="text" id="fecha_fin_1" name="fecha_fin_1" class="form-control campo-vd" disabled></div>',null,'36','5');
...
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('46','<div class="col-lg-6 col-md-6 col-sm-6"><label>Nombre</label> <input type="text" id="nombre_1" name="nombre_1" class="form-control campo-vd" maxlength="50" disabled ></div>',null,'37','3');
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('47','<div class="col-lg-6 col-md-6 col-sm-6"><label>Cargo</label> <input type="text" id="cargo_1" name="cargo_1" class="form-control campo-vd" maxlength="50" disabled ></div>',null,'37','4');
...
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('49','<div class="col-lg-12  col-md-12  col-sm-12"><label>(&) decreto 1674 donde se establece que las personas expuestas políticamente son aquellas que (a) Manejan recursos públicos, (b) Posee algún grado de poder público y/o (c) Tiene o
goza de reconocimiento o de influencia en la vida pública política.</label></div>',null,'37','6');
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('50','<div class="col-lg-12  col-md-12  col-sm-12"><label>(&&) Sociedad conyugal de hecho o derecho – Cónyuges, familiares hasta segundo grado de consanguinidad – Padres, Hijos, Abuelos, Hermanos, Nietos. Familiares hasta en el segundo
grado de afinidad – Suegros, Cuñados, Hijastros, Yernos, Nueras. Familiares hasta el primer grado civil – Padre adoptante, Hijo adoptivo.</label></div>',null,'37','7');
...
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('25','<div class="col-lg-6 col-md-6 col-sm-6"><input class="form-control campo-vd" type="text" name="valor_activo" id="valor_activo"  maxlength="17"></div>',null,'4','1');
Insert into VDIRMP.VDIR_RESPUESTA (COD_RESPUESTA,DES_RESPUESTA,PUNTUACION,COD_PREGUNTA,NUMERO_RESPUESTA) values ('26','<div class="col-lg-6 col-md-6 col-sm-6"><input class="form-control campo-vd" type="text" name="valor_pasivo" id="valor_pasivo"  maxlength="17" ></div>',null,'5','1');
...
--FUNCION PARA TRAER UNA ENCUESTA DETERMINADA-------------------------------
...
-----------------------------------------------------------------------------
 ...
 FUNCTION VDIR_FN_GET_ENCUESTA_SARLAF RETURN CLOB AS
  ...
  BEGIN
      ...
      vl_form_ini := '<div class="container"><form>';
      vl_form_fin := '</form></div>';
      ...
      vl_nombre_ant_modulo := '';
       ...
       FOR fila IN (SELECT
        ...
        LOOP
                IF fila.cod_pregunta NOT IN(4,5) AND fila2.cod_respuesta NOT IN(27,30,31,32,33,36,37,38,41,42,43,46,47,48,49,50,51) THEN                
                   vl_row_respuesta := vl_row_respuesta || '<div class="col-lg-6 col-md-6 col-sm-6">
                 ...
                 ELSIF fila2.cod_respuesta = 33 THEN
                      vl_row_respuesta := vl_row_respuesta || '<div class="col-lg-6 col-md-6 col-sm-6">' ||fila2.des_respuesta||VDIR_PACK_ENCUESTAS.VDIR_FN_GET_LIST_MONEDA||'</div>';
                 ELSIF fila2.cod_respuesta = 48 THEN
                     vl_row_respuesta := vl_row_respuesta || '<div class="col-lg-6 col-md-6 col-sm-6">' || fila2.des_respuesta||VDIR_PACK_ENCUESTAS.VDIR_FN_GET_LIST_PARENTESCO||'</div> <br>'; 
                 ELSE                  
                   vl_row_respuesta := vl_row_respuesta || fila2.des_respuesta;
                 END IF;
          END LOOP;
          ...
          END IF;         
            ...
            vl_row_pregunta := vl_row_pregunta || '<div class="row">
                                                       <div '||vl_style||' class="col-lg-12 col-md-12 col-sm-12" id="pregunta_'||CAST(fila.cod_pregunta AS VARCHAR2)||'">
    ...
    END IF;
     ...
     vl_cadena :=  vl_form_ini||vl_filset_all||'<div class="row text-center"><div class="col-lg-12 col-md-12 col-sm-12 text-center"><input type="button" value="Guardar" id="btn_guardar" name="btn_guardar" class="btn btn-primary"></div></div>'||vl_form_fin;
...
--------------------------------------------------------
  ...
  ALTER TABLE "VDIRMP"."VDIR_RESPUESTAS_MARCADAS" MODIFY ("COD_ENCUESTA_AFILIACION" NOT NULL ENABLE);
...
--------------------------------------------------------
  ...
  ALTER TABLE "VDIRMP"."VDIR_RESPUESTAS_MARCADAS" ADD FOREIGN KEY ("COD_ENCUESTA_AFILIACION")
	  REFERENCES "VDIRMP"."VDIR_AFILIACION_ENCUESTA" ("COD_ENCUESTA_AFILIACION") ENABLE;
